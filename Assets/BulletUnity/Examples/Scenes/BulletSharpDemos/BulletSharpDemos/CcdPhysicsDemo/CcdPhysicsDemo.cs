...
{
	internal class CcdPhysicsDemo : Demo
	{
		private bool ccdMode = true;
		private Vector3 eye = new Vector3(0, 20, 80);
		...
		protected override void OnInitializePhysics()
		{
			...
			var body = LocalCreateRigidBody(0, Matrix.Identity, ground);
			body.Friction = 0.5f;
			...
			for (i = 0; i < numObjects; i++)
			{
				...
				var trans = Matrix.Translation(col * 2 * CubeHalfExtents + (row2 % 2) * CubeHalfExtents,
