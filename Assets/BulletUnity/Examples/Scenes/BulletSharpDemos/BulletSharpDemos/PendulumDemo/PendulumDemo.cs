...
{
	internal class PendulumDemo : Demo
	{
		private Vector3 eye = new Vector3(-2, 0, 1);
		...
		protected override void OnInitializePhysics()
		{
			...
			//y-axis assumed up
			var parentComToCurrentCom = new Vector3(0, -linkHalfExtents[1], 0);
			var currentPivotToCurrentCom = new Vector3(0, -linkHalfExtents[1], 0);
			var parentComToCurrentPivot = parentComToCurrentCom - currentPivotToCurrentCom;

			for (int i = 0; i < numLinks; i++)
			{
				const float linkMass = 10;
				var linkInertiaDiag = Vector3.Zero;
			...
			for (int i = 0; i < numLinks; i++)
			{
				...
				var collisionFilterGroup = CollisionFilterGroups.Everything; // : CollisionFilterGroups.StaticFilter;
				var collisionFilterMask = CollisionFilterGroups.Everything; // : CollisionFilterGroups.AllFilter & ~CollisionFilterGroups.StaticFilter;
