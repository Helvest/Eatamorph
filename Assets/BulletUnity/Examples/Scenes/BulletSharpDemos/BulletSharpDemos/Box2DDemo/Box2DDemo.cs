...
namespace Box2DDemo
{
	internal class Box2DDemo : Demo
	{
		private Vector3 eye = new Vector3(0, 15, 20);
		private Vector3 target = new Vector3(10, 10, 0);

		///create 25 (5x5) dynamic objects
		private const int ArraySizeX = 5, ArraySizeY = 5;
		...
		protected override void OnInitializePhysics()
		{
			...
			var x = new Vector3(-ArraySizeX, 8, -20);
			var y = Vector3.Zero;
			var deltaX = new Vector3(1, 2, 0);
			var deltaY = new Vector3(2, 0, 0);
