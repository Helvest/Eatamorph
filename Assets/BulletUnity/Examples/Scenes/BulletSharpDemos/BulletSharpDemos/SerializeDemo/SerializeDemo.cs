...
{
	internal class CustomBulletWorldImporter : BulletWorldImporter
	{
		...
		{
			var body = base.CreateRigidBody(isDynamic, mass, ref startTransform, shape, bodyName);
	...
	internal class SerializeDemo : Demo
	{
		...
		protected override void OnInitializePhysics()
		{
			...
			if (!fileLoader.LoadFile(bulletFile))
			{
				...
				var ground = LocalCreateRigidBody(0, Matrix.Translation(0, -50, 0), groundShape);
				ground.UserObject = "Ground";

				// create a few dynamic rigidbodies
				float mass = 1.0f;

				var positions = new Vector3[2] { new Vector3(0.1f, 0.2f, 0.3f), new Vector3(0.4f, 0.5f, 0.6f) };
				...
				var p2p = new Point2PointConstraint((RigidBody)World.CollisionObjectArray[2], new Vector3(0, 1, 0));
				...
				var file = new FileStream("testFile.bullet", FileMode.Create);
