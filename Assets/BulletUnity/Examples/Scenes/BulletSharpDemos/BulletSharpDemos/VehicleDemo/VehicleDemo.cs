...
{
	internal class VehicleDemo : Demo
	{
		private Vector3 eye = new Vector3(35, 45, -55);
		...
		private float gBreakingForce = 0.0f;
		private const float maxEngineForce = 2000.0f;//this should be engine/velocity dependent
		private const float maxBreakingForce = 100.0f;
		private float gVehicleSteering = 0.0f;
		private const float steeringIncrement = 1.0f;
		private const float steeringClamp = 0.3f;
		public const float wheelRadius = 0.7f;
		public const float wheelWidth = 0.4f;
		private const float wheelFriction = 1000;//BT_LARGE_FLOAT;
		...
		protected override void OnInitializePhysics()
		{
			...
			var ground = LocalCreateRigidBody(0, tr, groundShape);
			...
			var localTrans = Matrix.Translation(Vector3.UnitY);
			compound.AddChildShape(localTrans, chassisShape);
			var carChassis = LocalCreateRigidBody(800, Matrix.Identity, compound);
			...
			var connectionPointCS0 = new Vector3(CUBE_HALF_EXTENTS - (0.3f * wheelWidth), connectionHeight, 2 * CUBE_HALF_EXTENTS - wheelRadius);
