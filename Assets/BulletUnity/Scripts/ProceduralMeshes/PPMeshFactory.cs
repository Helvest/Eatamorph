...
namespace BulletUnity
{
	...
	public class BUserMeshSettings : BPrimitiveMeshSettings
	{
		...
		public override Mesh Build()
		{
			...
			var mesh = UnityEngine.Object.Instantiate(UserMesh);  //create a copy of UserMesh, dont overwrite prefabs
	...
	public class BBoxMeshSettings : BPrimitiveMeshSettings
	{
		...
		public override Mesh Build()
		{
			var mesh = ProceduralPrimitives.CreateMeshBox(extents.x, extents.y, extents.z);
			return mesh;
		}
	}
	...
	public class BConeMeshSettings : BPrimitiveMeshSettings
	{
		...
		public override Mesh Build()
		{
			var mesh = ProceduralPrimitives.CreateMeshCone(height, radius, 0f, nbSides);
			return mesh;
		}
	}
...
=> new Vector3(radius, height / 2, radius);
		...
		public override Mesh Build()
		{
			var mesh = ProceduralPrimitives.CreateMeshCapsule(height, radius, nbSides, (int)upAxis);
			return mesh;
		}
	}
...
=> new Vector3(radius, height / 2, radius);
		...
		public override Mesh Build()
		{
			var mesh = ProceduralPrimitives.CreateMeshCylinder(height, radius, nbSides);
			return mesh;
		}
	}
	...
	public class BSphereMeshSettings : BPrimitiveMeshSettings
	{
		...
		public override Mesh Build()
		{
			var mesh = ProceduralPrimitives.CreateMeshSphere(radius, numLongitudeLines, numLatitudeLines);
			return mesh;
		}
	}
	...
	public class BAnyMeshSettingsForEditor : BAnyMeshSettings
	{
		...
		public static BAnyMeshSettingsForEditor Instance => instance = instance ?? new BAnyMeshSettingsForEditor();
	}
	...
	public class BPlaneMeshSettings : BPrimitiveMeshSettings
	{
		...
		public override Mesh Build()
		{
			var mesh = ProceduralPrimitives.CreateMeshPlane(length, width, resX, resZ);
			return mesh;
		}
	}
