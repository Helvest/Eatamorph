	...
	public class BPhysicsWorld : MonoBehaviour, IDisposable
	{
		...
		public static BPhysicsWorld Get()
		{
			if (singleton == null && !_isDisposed)
			{
				...
				var ws = FindObjectsOfType<BPhysicsWorld>();
			...
			set
			{
				if (_doDebugDraw != value && m_world != null)
				{
					if (value == true)
					{
						...
						{
							DebugMode = _debugDrawMode
						};
						m_world.DebugDrawer = db;
					}
					else
					{
						var db = m_world.DebugDrawer;
		...
		protected void Dispose(bool disposing)
		{
			...
			if (m_world != null)
			{
				...
				if (_ddWorld != null)
				{
					...
					{
						var constraint = _ddWorld.GetConstraint(i);
				...
				{
					var obj = m_world.CollisionObjectArray[i];
