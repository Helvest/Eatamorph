...
namespace BulletUnity
{
	public class BSoftBody : BCollisionObject, IDisposable
	{
		...
		public void DumpDataFromBullet()
		{
			if (isInWorld)
			{
				var m_BSoftBody = (SoftBody)collisionObject;
				...
				var totalVelocity = new BulletSharp.Math.Vector3(0);
				...
				for (int i = 0; i < m_BSoftBody.Nodes.Count; i++)
				{
					...
					totalVelocity += m_BSoftBody.Nodes[i].Velocity;
				}

				velocity = (totalVelocity / m_BSoftBody.Nodes.Count).ToUnity();
			}
		}
