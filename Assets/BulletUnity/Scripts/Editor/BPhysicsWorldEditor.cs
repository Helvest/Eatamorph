...
public class BDynamicsWorldEditor : Editor
{
	...
	private GUIContent gcDoDebugDraw = new GUIContent("Do Debug Draw");
	private GUIContent DebugDrawMode = new GUIContent("Debug Draw Mode");

	public override void OnInspectorGUI()
	{
		var pw = (BPhysicsWorld)target;
