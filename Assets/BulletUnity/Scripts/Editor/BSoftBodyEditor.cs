...
namespace BulletUnity
{
	...
	public class BSoftBodyEditor : Editor
	{
		...
		private SerializedProperty softBodySettings;

		//BulletSharp.SoftBody.Collisions collisions;  //bitmask field for collisions

		private GUIContent gcSoftBodySettings = new GUIContent("SoftBodySettings");
	   ...
	   "Default: Cluster soft body self collision.";
		private GUIContent gcCollisionTooltip = new GUIContent("Soft vs. Rigid Mask", collisionTooltip);
		private Color GUIBlue = new Color32(82, 140, 255, 255);
		private BAnyMeshSettingsForEditor inspectorMeshSettings;
		...
		public override void OnInspectorGUI()
		{
			...
			{
				var sb = (BSoftBodyPartOnSkinnedMesh)target;
		...
		private static void CreateBSoftBodyRope()
		{
		...
		private static void CreateBSoftWithMesh()
		{
			var settings = new BAnyMeshSettings
			{
				meshType = PrimitiveMeshOptions.Bunny
			};
		...
		/// </summary>
		private static void PostCreateObject()
		{
		...
		private void DrawCustomMeshSettingsOptions()
		{

			EditorGUILayout.LabelField("Generate Custom Mesh?", EditorStyles.boldLabel);

			//Get Instance
			var bAny = inspectorMeshSettings; //BAnyMeshSettingsForEditor.Instance;
