...
namespace BulletUnity.Primitives
{
	...
	public class BPrimitiveEditor : Editor
	{
		...
		private static GUIStyle versionStyle = new GUIStyle();
		...
		private GUIContent gcSize = new GUIContent("MeshSettings");
		...
		private static void CreateBCube()
		{
		...
		private static void CreateBSphere()
		{
		...
		private static void CreateBCylinder()
		{
		...
		private static void CreateBCapsule()
		{
		...
		private static void CreateBCone()
		{
		...
		private static void CreateBConvexHull()
		{
		...
		private static void CreateBConvexTriMesh()
		{
		...
		private static Vector3 GetCameraRaycastPosition()
		{
			...
			{
				if (Physics.Raycast(ray, out var hitInfo))  //raycast on existing geometry
				{
