...
namespace BulletUnity
{
	public class DebugDrawUnity : DebugDraw
	{
		...
		{
			var pos = BSExtensionMethods2.ExtractTranslationFromMatrix(ref trans);
			var rot = BSExtensionMethods2.ExtractRotationFromMatrix(ref trans);
			var scale = BSExtensionMethods2.ExtractScaleFromMatrix(ref trans);
