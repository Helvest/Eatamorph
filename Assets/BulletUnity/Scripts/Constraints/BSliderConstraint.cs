...
namespace BulletUnity
{
	...
	public class BSliderConstraint : BTypedConstraint
	{
		...
		{
			get => m_lowerAngularLimitRadians;
			set
			{
		...
		{
			get => m_upperAngularLimitRadians;
			set
			{
		...
		internal override bool _BuildConstraint()
		{
			...
			{
				var frameInA = BM.Matrix.Identity;
				string errormsg = string.Empty;
			...
			var sl = (SliderConstraint)m_constraintPtr;
