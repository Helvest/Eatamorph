...
namespace BulletUnity
{
	public class BCollisionObject : MonoBehaviour, IDisposable
	{
		...
		public virtual BICollisionCallbackEventHandler collisionCallbackEventHandler => m_onCollisionCallback;
		...
		internal virtual bool _BuildCollisionObject()
		{
			...
			if (collisionObject == null)
			{
				...
				MatrixB.RotationQuaternion(ref q, out var worldTrans);
		...
		public void _AddObjectToBulletWorld()
		{
