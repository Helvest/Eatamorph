...
namespace BulletUnity
{
	...
	public class BHeightfieldTerrainShape : BCollisionShape
	{
		...
		private HeightfieldTerrainShape _CreateTerrainShape()
		{
			...
			var tco = GetComponent<BTerrainCollisionObject>();
			if (tco == null)
			{
			...
			var file = new System.IO.MemoryStream(terr);
			...
			var hs = new HeightfieldTerrainShape(width, length, pinnedTerrainData.AddrOfPinnedObject(), 1f, 0f, maxHeight, upIndex, scalarType, false);
