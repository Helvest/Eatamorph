...
namespace BulletSharp
{
	public class SequentialImpulseConstraintSolver : ConstraintSolver
	{
		...
		*/
		...
		{
			get => btSequentialImpulseConstraintSolver_getRandSeed(_native);
		...
		*/
		...
		private static extern IntPtr btSequentialImpulseConstraintSolver_new();
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern ulong btSequentialImpulseConstraintSolver_btRand2(IntPtr obj);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern int btSequentialImpulseConstraintSolver_btRandInt2(IntPtr obj, int n);
		//[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		...
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern ulong btSequentialImpulseConstraintSolver_getRandSeed(IntPtr obj);
		//[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		...
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btSequentialImpulseConstraintSolver_setRandSeed(IntPtr obj, ulong seed);
	}
}
