...
namespace BulletSharp
{
	...
	internal class ActionInterfaceWrapper : IDisposable
	{
		...
		private static void DebugDrawUnmanaged(IntPtr iaPtrThis, IntPtr debugDrawer)
		{
			...
			var ai = GCHandle.FromIntPtr(iaPtrThis).Target as ActionInterfaceWrapper;
		...
		private static extern IntPtr btActionInterfaceWrapper_new(IntPtr debugDrawCallback, IntPtr updateActionCallback, IntPtr thisObj);

		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern IntPtr bgActionInterface_getManagedWrapperPntr(IntPtr obj);

		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btActionInterface_delete(IntPtr obj);
	}
}
