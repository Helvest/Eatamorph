...
namespace BulletSharp
{
	...
	public class AlignedBroadphasePairArray : IList<BroadphasePair>
	{
		...
		public int Count => btAlignedBroadphasePairArray_size(_native);
		...
		private static extern IntPtr btAlignedBroadphasePairArray_at(IntPtr obj, int n);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btAlignedBroadphasePairArray_push_back(IntPtr obj, IntPtr val);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btAlignedBroadphasePairArray_resizeNoInitialize(IntPtr obj, int newSize);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern int btAlignedBroadphasePairArray_size(IntPtr obj);
	}
}
