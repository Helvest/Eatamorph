...
namespace BulletSharp
{
	public class Chunk
	{
		...
		private static extern IntPtr btChunk_new();
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern int btChunk_getChunkCode(IntPtr obj);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern int btChunk_getDna_nr(IntPtr obj);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern int btChunk_getLength(IntPtr obj);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern int btChunk_getNumber(IntPtr obj);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern IntPtr btChunk_getOldPtr(IntPtr obj);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btChunk_setChunkCode(IntPtr obj, int value);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btChunk_setDna_nr(IntPtr obj, int value);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btChunk_setLength(IntPtr obj, int value);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btChunk_setNumber(IntPtr obj, int value);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btChunk_setOldPtr(IntPtr obj, IntPtr value);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btChunk_delete(IntPtr obj);
	}
	...
	public abstract class Serializer : IDisposable
	{
		...
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern IntPtr btSerializerWrapper_new(IntPtr allocateCallback, IntPtr finalizeChunkCallback,
		...
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btSerializer_delete(IntPtr obj);

		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern IntPtr getBulletDNAstr();
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern int getBulletDNAlen();
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern IntPtr getBulletDNAstr64();
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern int getBulletDNAlen64();
	}
	...
	public class DefaultSerializer : Serializer
	{
		...
		public override Chunk Allocate(uint size, int numElements)
		{
			...
			var ptr = InternalAlloc(length + ChunkInd.Size);
			var data = ptr.Add(ChunkInd.Size);
			var chunk = new Chunk(ptr, true)
			{
				ChunkCode = 0,
				OldPtr = data,
				Length = length,
		...
		public override void FinalizeChunk(Chunk chunk, string structType, DnaID chunkCode, IntPtr oldPtr)
		{
			...
			var uniquePtr = GetUniquePointer(oldPtr);
		...
		{
			_nameMap.TryGetValue(ptr, out var name);
			return name;
		}

		public override IntPtr FindPointer(IntPtr oldPtr)
		{
			_chunkP.TryGetValue(oldPtr, out var ptr);
			return ptr;
		}
		...
		public override void FinishSerialization()
		{
			...
			foreach (var ptr in _nameMap.Values)
			{
		...
		{
			_structReverse.TryGetValue(typeName, out var s);
			return s;
		}
		...
		public override IntPtr GetUniquePointer(IntPtr oldPtr)
		{
			...
			if (_uniquePointers.TryGetValue(oldPtr, out var uniquePtr))
			{
				return uniquePtr;
			}
		...
		protected unsafe void InitDna(byte[] bdnaOrg)
		{
			...
			for (int i = 0; i < dataLen; i++)
			{
				var structDecl = new Dna.StructDecl();
		...
		public override void SerializeName(IntPtr namePtr)
		{
			...
			var chunk = Allocate(sizeof(char), newLen);
			var destPtr = chunk.OldPtr;
		...
		{
			var dnaChunk = Allocate((uint)_dnaLength, 1);
