...
namespace BulletSharp
{
	...
	public class AlignedIndexedMeshArray : IList<IndexedMesh>
	{
		...
		public int Count => btAlignedIndexedMeshArray_size(_native);
		...
		private static extern IntPtr btAlignedIndexedMeshArray_at(IntPtr obj, int n);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btAlignedIndexedMeshArray_push_back(IntPtr obj, IntPtr val);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btAlignedIndexedMeshArray_resizeNoInitialize(IntPtr obj, int newSize);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern int btAlignedIndexedMeshArray_size(IntPtr obj);
	}
}
