...
namespace BulletSharp
{
	public static class GeometryUtil
	{
        ...
        */
		...
		private static extern bool btGeometryUtil_areVerticesBehindPlane([In] ref Vector3 planeNormal, IntPtr vertices, float margin);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btGeometryUtil_getPlaneEquationsFromVertices(IntPtr vertices, IntPtr planeEquationsOut);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btGeometryUtil_getVerticesFromPlaneEquations(IntPtr planeEquations, IntPtr verticesOut);
		//[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		//[return: MarshalAs(UnmanagedType.I1)]
		//static extern bool btGeometryUtil_isInside(IntPtr vertices, IntPtr planeNormal, float margin);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		[return: MarshalAs(UnmanagedType.I1)]
		private static extern bool btGeometryUtil_isPointInsidePlanes(IntPtr planeEquations, [In] ref Vector3 point, float margin);
	}
}
