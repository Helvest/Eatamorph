...
namespace BulletSharp
{
	public class PolarDecomposition : IDisposable
	{
		...
		private static extern IntPtr btPolarDecomposition_new();
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern IntPtr btPolarDecomposition_new2(float tolerance);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern IntPtr btPolarDecomposition_new3(float tolerance, uint maxIterations);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern uint btPolarDecomposition_decompose(IntPtr obj, [In] ref Matrix a, [Out] out Matrix u, [Out] out Matrix h);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern uint btPolarDecomposition_maxIterations(IntPtr obj);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btPolarDecomposition_delete(IntPtr obj);
	}
}
