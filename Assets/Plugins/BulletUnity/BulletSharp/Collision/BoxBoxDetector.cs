...
namespace BulletSharp
{
	public class BoxBoxDetector : DiscreteCollisionDetectorInterface
	{
		...
		private static extern IntPtr btBoxBoxDetector_new(IntPtr box1, IntPtr box2);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btBoxBoxDetector_setBox1(IntPtr obj, IntPtr value);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btBoxBoxDetector_setBox2(IntPtr obj, IntPtr value);
	}
}
