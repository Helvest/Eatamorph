...
namespace BulletSharp
{
	public class ScaledBvhTriangleMeshShape : ConcaveShape
	{
		...
		public BvhTriangleMeshShape ChildShape => _childShape;

		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern IntPtr btScaledBvhTriangleMeshShape_new(IntPtr childShape, [In] ref Vector3 localScaling);
	}
}
