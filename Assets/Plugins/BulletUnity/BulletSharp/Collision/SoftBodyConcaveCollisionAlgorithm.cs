...
namespace BulletSharp
{
	public class SoftBodyConcaveCollisionAlgorithm : CollisionAlgorithm
	{
		public class CreateFunc : CollisionAlgorithmCreateFunc
		{
			...
			private static extern IntPtr btSoftBodyConcaveCollisionAlgorithm_CreateFunc_new();
		}
		...
		public class SwappedCreateFunc : CollisionAlgorithmCreateFunc
		{
			...
			[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
			private static extern IntPtr btSoftBodyConcaveCollisionAlgorithm_SwappedCreateFunc_new();
		}
		...
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern IntPtr btSoftBodyConcaveCollisionAlgorithm_new(IntPtr ci, IntPtr body0Wrap, IntPtr body1Wrap, bool isSwapped);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btSoftBodyConcaveCollisionAlgorithm_clearCache(IntPtr obj);
	}
}
