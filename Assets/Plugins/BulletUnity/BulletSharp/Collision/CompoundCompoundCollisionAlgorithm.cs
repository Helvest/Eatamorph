...
namespace BulletSharp
{
	public class CompoundCompoundCollisionAlgorithm : CompoundCollisionAlgorithm
	{
		public new class CreateFunc : CollisionAlgorithmCreateFunc
		{
			...
			private static extern IntPtr btCompoundCompoundCollisionAlgorithm_CreateFunc_new();
		}
		...
		public new class SwappedCreateFunc : CollisionAlgorithmCreateFunc
		{
			...
			[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
			private static extern IntPtr btCompoundCompoundCollisionAlgorithm_SwappedCreateFunc_new();
		}
		...
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern IntPtr btCompoundCompoundCollisionAlgorithm_new(IntPtr ci, IntPtr body0Wrap, IntPtr body1Wrap, bool isSwapped);
	}
}
