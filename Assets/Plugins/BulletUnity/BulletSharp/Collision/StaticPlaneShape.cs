...
namespace BulletSharp
{
	public class StaticPlaneShape : ConcaveShape
	{
		...
		public float PlaneConstant => btStaticPlaneShape_getPlaneConstant(_native);

		public Vector3 PlaneNormal
		{
			get
			{
				btStaticPlaneShape_getPlaneNormal(_native, out var value);
				return value;
			}
		}

		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern IntPtr btStaticPlaneShape_new([In] ref Vector3 planeNormal, float planeConstant);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern float btStaticPlaneShape_getPlaneConstant(IntPtr obj);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btStaticPlaneShape_getPlaneNormal(IntPtr obj, [Out] out Vector3 value);
	}
