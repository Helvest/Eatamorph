...
namespace BulletSharp
{
	public class ContinuousConvexCollision : ConvexCast
	{
		...
		private static extern IntPtr btContinuousConvexCollision_new(IntPtr shapeA, IntPtr shapeB, IntPtr simplexSolver, IntPtr penetrationDepthSolver);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern IntPtr btContinuousConvexCollision_new2(IntPtr shapeA, IntPtr plane);
	}
}
