...
namespace BulletSharp
{
	public abstract class TriangleRaycastCallback : TriangleCallback
	{
		...
		{
			var v10 = point1 - point0;
			var v20 = point2 - point0;

			var triangleNormal = v10.Cross(v20);

			point0.Dot(ref triangleNormal, out float dist);
			...
			if (distance < HitFraction)
			{
				...
				var point = Vector3.Lerp(From, To, distance);
				{
					Vector3 v0p;
					v0p = point0 - point;
					Vector3 v1p;
					...
					cp0.Dot(ref triangleNormal, out float dot);
