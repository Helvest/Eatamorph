...
namespace BulletSharp
{
	public class MultiSphereShape : ConvexInternalAabbCachingShape
	{
		...
		{
			btMultiSphereShape_getSpherePosition(_native, index, out var value);
			return value;
		}
        ...
        */
		public int SphereCount => btMultiSphereShape_getSphereCount(_native);

		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern IntPtr btMultiSphereShape_new(Vector3[] positions, float[] radi, int numSpheres);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern IntPtr btMultiSphereShape_new2(IntPtr positions, float[] radi, int numSpheres);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern int btMultiSphereShape_getSphereCount(IntPtr obj);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btMultiSphereShape_getSpherePosition(IntPtr obj, int index, [Out] out Vector3 value);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern float btMultiSphereShape_getSphereRadius(IntPtr obj, int index);
	}
}
