...
namespace BulletSharp
{
	public class CompoundShapeChild
	{
		...
		{
			get => btCompoundShapeChild_getChildMargin(_native);
		...
		{
			get => btCompoundShapeChild_getChildShapeType(_native);
		...
		public DbvtNode Node
		{
			get
			{
				var ptr = btCompoundShapeChild_getNode(_native);
		...
		public Matrix Transform
		{
			get
			{
				btCompoundShapeChild_getTransform(_native, out var value);
				return value;
			}
		...
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern BroadphaseNativeType btCompoundShapeChild_getChildShapeType(IntPtr obj);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern IntPtr btCompoundShapeChild_getNode(IntPtr obj);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		...
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btCompoundShapeChild_setChildShapeType(IntPtr obj, BroadphaseNativeType value);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btCompoundShapeChild_setNode(IntPtr obj, IntPtr value);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
	...
	public class CompoundShape : CollisionShape
	{
		...
		{
			btCompoundShape_getChildTransform(_native, index, out var value);
			return value;
		}
		...
		public Dbvt DynamicAabbTree => new Dbvt(btCompoundShape_getDynamicAabbTree(_native), true);

		public int NumChildShapes => _childList.Count;

		public int UpdateRevision => btCompoundShape_getUpdateRevision(_native);

		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern IntPtr btCompoundShape_new();
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern IntPtr btCompoundShape_new2(bool enableDynamicAabbTree);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern IntPtr btCompoundShape_new3(bool enableDynamicAabbTree, int initialChildCapacity);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btCompoundShape_calculatePrincipalAxisTransform(IntPtr obj, float[] masses, [In] ref Matrix principal, [In] ref Vector3 inertia);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		...
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern IntPtr btCompoundShape_getDynamicAabbTree(IntPtr obj);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		...
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btCompoundShape_updateChildTransform(IntPtr obj, int childIndex, [In] ref Matrix newChildTransform);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btCompoundShape_updateChildTransform2(IntPtr obj, int childIndex, [In] ref Matrix newChildTransform, bool shouldRecalculateLocalAabb);
	}
