...
namespace BulletSharp
{
	public class TriangleMeshShape : ConcaveShape
	{
		...
		{
			btTriangleMeshShape_localGetSupportingVertex(_native, ref vec, out var value);
			return value;
		}
		...
		{
			btTriangleMeshShape_localGetSupportingVertexWithoutMargin(_native, ref vec, out var value);
			return value;
		}
		...
		public Vector3 LocalAabbMax
		{
			get
			{
				btTriangleMeshShape_getLocalAabbMax(_native, out var value);
				return value;
			}
		}
		...
		public Vector3 LocalAabbMin
		{
			get
			{
				btTriangleMeshShape_getLocalAabbMin(_native, out var value);
				return value;
			}
		}
		...
		private static extern void btTriangleMeshShape_getLocalAabbMax(IntPtr obj, [Out] out Vector3 value);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btTriangleMeshShape_getLocalAabbMin(IntPtr obj, [Out] out Vector3 value);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern IntPtr btTriangleMeshShape_getMeshInterface(IntPtr obj);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btTriangleMeshShape_localGetSupportingVertex(IntPtr obj, [In] ref Vector3 vec, [Out] out Vector3 value);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btTriangleMeshShape_localGetSupportingVertexWithoutMargin(IntPtr obj, [In] ref Vector3 vec, [Out] out Vector3 value);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btTriangleMeshShape_recalcLocalAabb(IntPtr obj);
	}
