...
namespace BulletSharp.SoftBody
{
	...
	public class AlignedFaceArray : IList<Face>
	{
		...
		public int Count => btAlignedSoftBodyFaceArray_size(_native);
		...
		private static extern IntPtr btAlignedSoftBodyFaceArray_at(IntPtr obj, int n);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btAlignedSoftBodyFaceArray_push_back(IntPtr obj, IntPtr val);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btAlignedSoftBodyFaceArray_resizeNoInitialize(IntPtr obj, int newSize);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern int btAlignedSoftBodyFaceArray_size(IntPtr obj);
	}
}
