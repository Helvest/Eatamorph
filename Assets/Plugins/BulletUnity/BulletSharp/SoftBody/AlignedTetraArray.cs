...
namespace BulletSharp.SoftBody
{
	...
	public class AlignedTetraArray : IList<Tetra>
	{
		...
		public int Count => btAlignedSoftBodyTetraArray_size(_native);
		...
		private static extern IntPtr btAlignedSoftBodyTetraArray_at(IntPtr obj, int n);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btAlignedSoftBodyTetraArray_push_back(IntPtr obj, IntPtr val);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btAlignedSoftBodyTetraArray_resizeNoInitialize(IntPtr obj, int newSize);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern int btAlignedSoftBodyTetraArray_size(IntPtr obj);
	}
}
