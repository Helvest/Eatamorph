...
namespace BulletSharp.SoftBody
{
	...
	public class NodePtrArray : FixedSizeArray, IList<Node>
	{
		...
		public Node this[int index]
		{
			...
			set => btSoftBodyNodePtrArray_set(_native, value._native, index);
		}
		...
		private static extern IntPtr btSoftBodyNodePtrArray_at(IntPtr obj, int n);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern IntPtr btSoftBodyNodePtrArray_set(IntPtr obj, IntPtr value, int index);
	}
}
