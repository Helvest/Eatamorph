...
namespace BulletSharp.SoftBody
{
	...
	public class AlignedClusterArray : IList<Cluster>
	{
		...
		public int Count => btAlignedSoftBodyClusterArray_size(_native);
		...
		private static extern IntPtr btAlignedSoftBodyClusterArray_at(IntPtr obj, int n);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btAlignedSoftBodyClusterArray_push_back(IntPtr obj, IntPtr val);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btAlignedSoftBodyClusterArray_resizeNoInitialize(IntPtr obj, int newSize);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern int btAlignedSoftBodyClusterArray_size(IntPtr obj);
	}
}
