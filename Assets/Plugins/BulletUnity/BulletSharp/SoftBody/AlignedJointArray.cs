...
namespace BulletSharp.SoftBody
{
	...
	public class AlignedJointArray : IList<Joint>
	{
		...
		public int Count => btAlignedSoftBodyJointArray_size(_native);
		...
		private static extern IntPtr btAlignedSoftBodyJointArray_at(IntPtr obj, int n);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btAlignedSoftBodyJointArray_push_back(IntPtr obj, IntPtr val);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btAlignedSoftBodyJointArray_resizeNoInitialize(IntPtr obj, int newSize);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern int btAlignedSoftBodyJointArray_size(IntPtr obj);
	}
}
