...
namespace BulletSharp.SoftBody
{
	...
	public class AlignedMaterialArray : IList<Material>
	{
		...
		public int Count => btAlignedSoftBodyMaterialArray_size(_native);
		...
		private static extern IntPtr btAlignedSoftBodyMaterialArray_at(IntPtr obj, int n);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btAlignedSoftBodyMaterialArray_push_back(IntPtr obj, IntPtr val);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btAlignedSoftBodyMaterialArray_resizeNoInitialize(IntPtr obj, int newSize);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern int btAlignedSoftBodyMaterialArray_size(IntPtr obj);
	}
}
