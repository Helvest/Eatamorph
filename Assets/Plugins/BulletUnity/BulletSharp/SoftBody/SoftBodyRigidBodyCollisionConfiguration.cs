...
namespace BulletSharp
{
	public class SoftBodyRigidBodyCollisionConfiguration : DefaultCollisionConfiguration
	{
		...
		private static extern IntPtr btSoftBodyRigidBodyCollisionConfiguration_new();
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern IntPtr btSoftBodyRigidBodyCollisionConfiguration_new2(IntPtr constructionInfo);
	}
}
