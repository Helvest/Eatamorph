...
namespace BulletSharp.SoftBody
{
	...
	public class AlignedSoftBodyArray : IList<SoftBody>
	{
		...
		public int Count => btAlignedSoftBodyArray_size(_native);
		...
		private static extern IntPtr btAlignedSoftBodyArray_at(IntPtr obj, int n);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btAlignedSoftBodyArray_push_back(IntPtr obj, IntPtr val);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btAlignedSoftBodyArray_resizeNoInitialize(IntPtr obj, int newSize);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern int btAlignedSoftBodyArray_size(IntPtr obj);
	}
}
