...
namespace BulletSharp.SoftBody
{
	...
	public class AlignedAnchorArray : IList<Anchor>
	{
		...
		public int Count => btAlignedSoftBodyAnchorArray_size(_native);
		...
		private static extern IntPtr btAlignedSoftBodyAnchorArray_at(IntPtr obj, int n);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btAlignedSoftBodyAnchorArray_push_back(IntPtr obj, IntPtr val);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btAlignedSoftBodyAnchorArray_resizeNoInitialize(IntPtr obj, int newSize);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern int btAlignedSoftBodyAnchorArray_size(IntPtr obj);
	}
}
