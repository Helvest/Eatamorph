...
namespace BulletSharp.SoftBody
{
	...
	public class AlignedLinkArray : IList<Link>
	{
		...
		public Link this[int index]
		{
			...
			set => btAlignedSoftBodyLinkArray_set(_native, value._native, index);
		}
		...
		public int Count => btAlignedSoftBodyLinkArray_size(_native);
		...
		private static extern IntPtr btAlignedSoftBodyLinkArray_at(IntPtr obj, int n);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btAlignedSoftBodyLinkArray_push_back(IntPtr obj, IntPtr val);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btAlignedSoftBodyLinkArray_resizeNoInitialize(IntPtr obj, int newSize);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern void btAlignedSoftBodyLinkArray_set(IntPtr obj, IntPtr val, int index);
		[DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
		private static extern int btAlignedSoftBodyLinkArray_size(IntPtr obj);
	}
}
